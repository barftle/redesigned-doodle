...
collatz:
  ...
  .start:
	...
	JA .if  	; Wenn Parameter 1 größer 1, dann spring zu .if 
				; sonst nicht.
  ...
  .if:
	...
	JC .else 	; wenn carry Flag kommt (beim teilen von Zahl wird 
				; ein Bit übertragen, wegen dem Rest, in das 
				; nächsthöchere Bit) springt zur Funktion _else 
				; sonst nicht.
